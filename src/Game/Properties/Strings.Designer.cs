...
namespace BadEcho.Game.Properties {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to No shaders are available for the active graphics backend..
        /// </summary>
        internal static string NoShadersForGraphicsBackend {
            get {
                return ResourceManager.GetString("NoShadersForGraphicsBackend", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Failed to retrieve SDL window manager with error: {0}.
        /// </summary>
        internal static string SdlGetWindowManagerFailed {
            get {
                return ResourceManager.GetString("SdlGetWindowManagerFailed", resourceCulture);
            }
        }
